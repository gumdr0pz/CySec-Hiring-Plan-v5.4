...
| Metric | Value |
|--------|-------|
| **Target Revenue** | RM12,000,000 |
| **Revenue Streams** | Cybersecurity services, Blockchain development, Consulting |
| **Target Clients** | Enterprise, Government, SMEs |

### 2.2 Revenue Breakdown by Function

| Function | Expected Revenue Contribution | % of Total |
|----------|-------------------------------|------------|
| Government Security | RM4,000,000 | 33.3% |
| VORON / GRC | RM2,500,000 | 20.8% |
| Offensive Security | RM1,500,000 | 12.5% |
| Threat Intelligence | RM1,000,000 | 8.3% |
| DevSecOps | RM1,000,000 | 8.3% |
| Blockchain | RM1,000,000 | 8.3% |
| Professional Services | RM1,000,000 | 8.3% |
| **Total** | **RM12,000,000** | **100%** |
...
```
Cost is the gross base benchmark salary; no multiplier is applied.
...
Annual base: RM954,000 – RM1,288,800/yr
...
| Senior Engineer – Threat Intelligence | L3 | RM96,000 | RM132,000 |
| Engineer – Threat Intelligence | L1 | RM48,000 | RM84,000 |
| Engineer – Threat Intelligence (Dist. Intel) | L1 | RM48,000 | RM84,000 |
| Business Analyst | L1 | RM48,000 | RM84,000 |
| **Total** | | **RM474,000** | **RM738,000** |

Annual base: RM474,000 – RM738,000/yr

---

## 5. TOTAL COST SUMMARY

### 5.1 Wave Comparison (Base)
...
| Function | Core/General | Positions | Annual (Min) | Annual (Max) |
|----------|--------------|-----------|--------------|--------------|
| Government Security | Cyber-core | 1 | RM138,000 | RM186,000 |
| VORON / GRC | Cyber-core | 2 | RM186,000 | RM270,000 |
| Offensive Security | Cyber-core | 3 | RM324,000 | RM456,000 |
| Threat Intelligence | Cyber-core | 4 | RM330,000 | RM486,000 |
...
| 1 | Hiring | RM0 | RM0 |
| 2 | Hiring | RM0 | RM0 |
| 3 | W1 | RM79,500 | RM79,500 |
| 4 | W1 | RM79,500 | RM159,000 |
...
**Assumptions:**
- **Year 1:** phased onboarding (Wave 1 from ~Month 3 → ~10 months active, Wave 2 from ~Month 8 → ~5 months, Wave 3 from ~Month 12 → ~1 month), so Year 1 is a partial-year cost.
...
- All figures at the Rate-card base benchmark salary (no multiplier).
...
### 8.1 Revenue Sensitivity (base cost fixed at benchmark)
