# Cybersecurity BU — Job Descriptions (v6, 20-Position Structure)

**Updated:** June 24, 2026
**Scope:** 20 hire positions (Waves 1–3). The existing leadership roles are already filled and not included.
**Source of truth:** `../CySec-v6-Levels-Titles-Salary-Framework.md` and `../CySec-Manpower-Requisitions-v6.md`.
...
| MRF-016 | Senior Engineer – Threat Intelligence | L3 | C | CTI | Team Lead – Threat Intelligence | [open](MRF-016-threat-intelligence-researcher.md) |
| MRF-015 | Engineer – Threat Intelligence | L1 | C | CTI | Team Lead – Threat Intelligence | [open](MRF-015-threat-intelligence-analyst.md) |
| MRF-017 | Engineer – Threat Intelligence (Distributed Intel) | L1 | C | CTI | Team Lead – Threat Intelligence | [open](MRF-017-distributed-intelligence-analyst.md) |
| MRF-019 | Business Analyst | L1 | G | Product / PM | Product Manager | [open](MRF-019-business-analyst.md) |
